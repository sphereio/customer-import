...
1. Clone the repo with `git clone git@github.com:sphereio/customer-import.git`
2. Run `npm install`
3. To run all packages unit tests, simply run `npm test` (we use [mocha](https://github.com/mochajs/mocha)).
4. To run all integration tests, simply run `npm test:ci`
...
## Tests
We use [mocha](https://github.com/mochajs/mocha) for unit and integration test. You can use [Cucumber](https://github.com/cucumber/cucumber-js) for acceptance tests.
